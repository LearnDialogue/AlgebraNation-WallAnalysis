...
ldamodel = LdaMulti(doc_term_matrix, num_topics=8, id2word = dictionary, passes=20)

ldamodel.save('ldamodelMods2.model')

print(ldamodel.print_topics(num_topics=8, num_words=20))
