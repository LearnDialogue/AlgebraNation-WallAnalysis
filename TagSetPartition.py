...
try:
	for row in a:
		...
		tw = str(threadwords)
		if mainid%40 == 0:
			sqlInsert2 = "INSERT INTO PostTaggingBackup (postGroup,threadwords) VALUES (%s,%s)"
		else:
			sqlInsert2 = "INSERT INTO PostUnlabelledBackup (postGroup,threadwords) VALUES (%s,%s)"

		c.execute(sqlInsert2, (sentence, tw))
		#print flag
		#print tw
